...
Usage: measure.py FILE.tex|FILE.pdf [--engine ...] [--capacity-lines 46-48] [--capacity-chars 110] [--json]
...
def measure(pdf, tex_text: str = "", capacity_lines=(46, 48), capacity_chars=110) -> Measurement:
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--capacity-lines", default="46-48", type=parse_range)
